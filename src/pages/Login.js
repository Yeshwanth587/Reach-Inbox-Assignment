  ...
  return (
    <div className='bg-black max-w-[1440px] h-screen m-auto text-white  flex flex-col justify-between'>
        <div className=" w-full h-16 flex justify-center items-center border border-slate-800">
            <img src="https://s3-alpha-sig.figma.com/img/37f3/2626/1680d9613629542a2474f79f92f7c022?Expires=1725235200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=pEixXZm3Oa~HQGQbPCaHtUvTwKiYNl3z3-96HB4DdYWCyOumtzRcRE6Uxwepwhw1HWCom60ZKU6oZTQTXBYbpdGQHqy1UPQrELDx8qrQSla7EmAYFd~~qzRmBLzxVYXUtpYhNMv2Dmv-vSJBugbZSBf5B38s0R023vuHEW~vZ~~IWlLRSzMMSwCV04Xl9NfaGRCyDbWgu1zdQoSbi7o1SQ5NtcOQDHNkPsn7t7KHJqr4zYDzuerqAJt~E-LjpERfNhZZCYIiHmgMrSuieYwOuYVgO0t8IZHKG5vpvA8xh0iZYmbGO1O122WausqmAux7f899JmutovkNG5J47UeSBA__" alt="reachinbox-logo" className="h-7" />
        </div>
            ...
            <div className=' m-auto w-[460px] h-auto md:h-[312px]  bg-[#111214] rounded-2xl border border-gray-700  py-6  px-10 '>
                <div className=' w-[380px] m-auto'>
                    ...
                    <div className='rounded border border-gray-500 h-12 flex justify-center items-center gap-2.5  mb-12'>
                        ...
                        <Link  to="https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_to=http://localhost:3000/DashBoard" className='text-sm text-gray-400 cursor-pointer'> Sign Up with Google </Link>
                    </div>
